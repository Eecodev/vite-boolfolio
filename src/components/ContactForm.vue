<template>
    <form @submit.prevent="submitForm">
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="name" aria-describedby="nameHelp" v-model="name">
        ...
        <div class="mb-3">
            <label for="message" class="form-label">Yor Message</label>
            <textarea class="form-control" id="message" aria-describedby="message" v-model="message"></textarea>
